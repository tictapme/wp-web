...
/******/ 	return __webpack_require__(__webpack_require__.s = "./functions/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
addEventListener('fetch', async (event) => {
    ...
    const isForm = request.method === 'GET' && request.url.includes('/wp-admin/admin-ajax.php');
    if (isForm) {
        ...
        event.respondWith(await fetch(endpointUrl, {
            method: "POST",
